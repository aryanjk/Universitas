...
public class std{
	...
	public std(String f_name, String l_name, String email, int std_contact, String parents_name, String parent_contact, String password, String dob, String security_qn, String security_ans) {
		this.f_name = f_name;
		this.l_name = l_name;
		this.email = email;
	...
	public std(JTextField emailText, JPasswordField passText) {
    }
