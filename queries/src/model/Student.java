...
public class Student {
	...
	public Student(String f_name, String l_name, String email, String std_contact, String parents_name,
			String parent_contact, String password, String dob, String security_qn, String security_ans) {
		this.f_name = f_name;
		this.l_name = l_name;
		this.email = email;
